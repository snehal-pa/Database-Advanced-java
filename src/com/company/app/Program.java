...
public class Program {
    ...
    public void run() {
        ...
        productTable.insert(new Product(32020925, "Ninja lego", 499.9f));
...
//        personTable.update("personnumber", "1759007534", "name", "Saya");
//
//
//        productTable.removeData("modelnumber", "33620915");
//       personTable.removeData("personnumber", 1759007534);
